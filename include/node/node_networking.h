...
int main(int argc, char **argv) {
    ...
    int server_info_size = sizeof(server_net_info);      // c_len
    ...
    unsigned char message_received[MAX_LINE];  // Variable for server response messages
    unsigned char message_to_send[MAX_LINE];  // Variable for server response messages
